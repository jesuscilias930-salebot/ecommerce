...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="es-MX"><body><ShopProvider><a className="skip" href="#contenido">Saltar al contenido</a><Header/>{children}<footer><Link className="brand" href="/">merlyn<span>mayoreo</span></Link><p>Pequeños comienzos. Grandes posibilidades.</p><div><Link href="/paquetes">Explorar paquetes</Link><Link href="/ayuda">Ayuda y contacto</Link><Link href="/referencias">Referencias</Link><Link href="/#comunidad">Comunidad</Link><Link href="/ayuda#envios">Envíos</Link><Link href="/ayuda#cambios">Cambios y devoluciones</Link></div><small>© {new Date().getFullYear()} Merlyn · Precios en MXN</small></footer></ShopProvider></body></html>}
