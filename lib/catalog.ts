...
export type Package = { imageUrl?:string|null; id: number; name: string; price: number; available: number; pieces: number; boxLengthCm?:number|null; boxWidthCm?:number|null; boxHeightCm?:number|null; boxWeightKg?:number|null; items: { id?:number; productId?:number; name: string; quantity: number; assignedUnitPrice?:number|null }[]; tone: number };
type Bundle = { imageUrl?:string|null; id: number; name: string; fixedPrice: number | string; boxLengthCm?:number|string|null; boxWidthCm?:number|string|null; boxHeightCm?:number|string|null; boxWeightKg?:number|string|null; items: { id?:number; productId: number; productName: string; quantity: number; assignedUnitPrice?:number|string|null }[] };
...
const bundleDetails=(b:Bundle)=>({imageUrl:b.imageUrl,
