...
const demoBundles:Bundle[]=[
 ...
 {id:2,name:'Caja emprendedora',fixedPrice:2490,boxLengthCm:40,boxWidthCm:30,boxHeightCm:30,boxWeightKg:5.2,items:[{id:4,productId:900000001,productName:'Calcetín caricatura dama',quantity:60,assignedUnitPrice:14},{id:5,productId:900000002,productName:'Calcetín caricatura caballero',quantity:60,assignedUnitPrice:14},{id:6,productId:900000004,productName:'Calcetín deportivo negro',quantity:60,assignedUnitPrice:13.5}]},
 {id:3,name:'Dale más a tu negocio',fixedPrice:3990,boxLengthCm:50,boxWidthCm:40,boxHeightCm:35,boxWeightKg:8.5,items:[{id:7,productId:900000001,productName:'Calcetín caricatura dama',quantity:100,assignedUnitPrice:13.3},{id:8,productId:900000002,productName:'Calcetín caricatura caballero',quantity:100,assignedUnitPrice:13.3},{id:9,productId:900000004,productName:'Calcetín deportivo negro',quantity:100,assignedUnitPrice:13.3}]},
 {id:4,name:'Esenciales deportivos',fixedPrice:1890,boxLengthCm:35,boxWidthCm:30,boxHeightCm:25,boxWeightKg:3.1,items:[{id:10,productId:900000003,productName:'Calcetín deportivo blanco',quantity:50,assignedUnitPrice:18.9},{id:11,productId:900000004,productName:'Calcetín deportivo negro',quantity:50,assignedUnitPrice:18.9}]},
];
