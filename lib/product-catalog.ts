...
export async function stockApi(path:string, body?:unknown) {
 ...
 const allowed=['/public/store/products/in-stock','/public/store/price-rules','/public/store/quote','/public/store/orders','/public/store/bundles','/public/store/checkout'];
